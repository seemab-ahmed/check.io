    ...
    <section>
      <div className="container">
        <div className="p-1.5 rounded-[20px] bg-white">
          <div className="border-[2px] border-[#CEE8FF] rounded-[18px] bg-[#EBF5FF] py-8 px-16 grid grid-cols-1 md:grid-cols-2 gap-[70px]">
            <div>
            ...
            <div>
              ...
              <span className="text-xl font-medium leading-tight text-customDarkGrayLight mb-4 block">
                čo bude ďalej?
              </span>
