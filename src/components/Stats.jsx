...
import statsCardImg1 from "../assets/images/stat-img1.svg"
import statsCardImg2 from "../assets/images/stat-img2.svg"
import statsCardImg3 from "../assets/images/stat-img3.svg"
import statsCardImg4 from "../assets/images/stat-img4.svg"
import statsCardImg5 from "../assets/images/stat-img5.svg"
          ...
          <div className="flex justify-between items-center flex-wrap relative z-[1] max-w-[1320px] mx-auto w-full">
            {statsData.map((item)=> (
                <div className="flex flex-col justify-center items-center">
                    <img src={item.icon} alt={item.title} className="mb-5" />
